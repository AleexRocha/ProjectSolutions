                    ...
                    <tbody >
                        ...
                        <c:forEach var="produtos" items="${listaProdutos}">
                            <td class="coluna" name="codigo">
                                <c:out value="${produtos.codigo}" />
                            </td>
                            <td class="coluna" name="nome">
                                <c:out value="${produtos.nome}" />
                            </td>
                            <td class="coluna" name="descricao">
                                <c:out value="${produtos.descricao}" />
                            </td>
                            <td class="coluna" name="tipo">
                                <c:out value="${produtos.tipo}" />
                            </td>
                            ...
                            <td class="btn-group">
                                ...
                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteProduto"
                                        <c:if test="${sessionScope.nomeSetor == 'Estoquista'}"> disabled=""</c:if>
                                        value="${produtos.codigo}" onclick="defineCodigo(this.value)">
